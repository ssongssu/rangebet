        ...
        if (user) {
            ...
            loadUserProfile(user.uid).then(profile => {
                ...
                if (userProfile.username) {
                    ...
                    console.log("Username not found in profile");
...
function updateOnlineStatus(isOnline) {
    ...
    console.log(`Updating online status to ${isOnline} for user ${currentUser.uid}`);
    ...
    const balance = userProfile?.balance || 1000;
